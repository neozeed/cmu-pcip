...
int_print(number, radix, sined, field, l_zero, routine, outarg)
unsigned long	number; /* the number to print */
int	radix;		/* the radix to print the number in */
int	sined;		/* true if should print as signed number */
