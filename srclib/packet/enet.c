...
/* $Revision:   1.0  $		$Date:   04 Mar 1988 16:32:32  $	*/
/*
 * $Log:   C:/KARL/CMUPCIP/SRCLIB/PKT/ENET.C_V  $
 * 
 *    Rev 1.0   04 Mar 1988 16:32:32
 * Initial revision.
*/
...
char _net_if_name = 'D';	/* DDP - Default NETCUST = "NETCUSTD" */
...
NET nets[1] = { "PKT DRVR Ethernet",	/* interface name */
