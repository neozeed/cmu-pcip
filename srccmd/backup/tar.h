...
#ifdef	MSDOS
#define major(x) ((unsigned char)(x))
#define minor(x) ((unsigned char)((x)>>8))
#define makedev(mj, mi) ((mj) | (((unsigned short)(mi))<<8))
#define bcopy(f, t, cnt) memcpy(t, f, cnt)
#define bzero(t, cnt) memset(t, 0, cnt)
#endif
